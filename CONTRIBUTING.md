...
Welcome, and thank you for considering contributing to **cxagenthooks** (`github.com/CheckmarxDev/ast-cx-hooks`) — one hook codebase that runs across every supported AI coding agent.
