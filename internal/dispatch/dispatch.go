// Package dispatch provides the core routing primitives for agenthooks.
// It is internal to this module; callers use the re-exported symbols in the
// root agenthooks package.
package dispatch
